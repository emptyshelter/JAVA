		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				update.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (!mainFrame.getNowLogin().equals("관리자")) {
							JOptionPane.showMessageDialog(null, "관리자 이외에는 수정이 불가능합니다.");
						} else if (mainFrame.getNowLogin().equals("관리자")) {
							BbsVo temp = new BbsVo(bbsVo.getNo(), titleTF.getText(), bbsVo.getWriter(), dTime + "(수정)",
									textA.getText());
			...
			}
			{
				...
				delete.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (!mainFrame.getNowLogin().equals("관리자")) {
							JOptionPane.showMessageDialog(null, "관리자 이외에는 삭제가 불가능합니다.");
						} else if (mainFrame.getNowLogin().equals("관리자")) {
							try {
